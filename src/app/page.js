  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-50 via-slate-100 to-slate-200">
      ...
      <header className="px-4">
        <div className="mx-auto max-w-5xl pt-10 pb-4 text-center">
      ...
      <div className="mx-auto max-w-5xl px-4 pb-12">
        ...
        <section aria-labelledby="lesetekster-heading" className="mt-6">
          <div className="flex items-baseline justify-between gap-3">
            ...
            <span className="text-[11px] sm:text-xs text-slate-500">3 tekster</span>
          </div>

          <ul className="mt-3 grid gap-3 sm:gap-4 md:gap-5 grid-cols-1 sm:grid-cols-2">
            {/* Elisabeth */}
            <li className="group">
              <Link
                href="/kjell"
                className="block rounded-2xl bg-white/90 backdrop-blur shadow-sm ring-1 ring-slate-200 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
              >
                <div className="p-4 sm:p-5">
                  <div className="flex flex-wrap items-center gap-2 text-[11px] sm:text-xs font-semibold text-blue-700">
        ...
        <section aria-labelledby="quiz-heading">
          ...
          <ul className="mt-3 grid gap-3 sm:gap-4 md:gap-5 grid-cols-1 sm:grid-cols-2">
            ...
            <li className="group">
              ...
              >
                <div className="p-4 sm:p-5">
                  <div className="inline-flex items-center rounded-full bg-emerald-50 px-2 py-0.5 text-[11px] sm:text-xs font-semibold text-emerald-700 ring-1 ring-emerald-100">
                    Quiz
                  </div>
                  <p className="mt-2 text-sm sm:text-base font-medium text-emerald-700 group-hover:text-emerald-800">
